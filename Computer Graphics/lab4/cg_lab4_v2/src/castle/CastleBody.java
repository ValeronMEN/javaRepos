...
public class CastleBody {
    ...
    private static Appearance getBodyAppearence() {
        ...
        TextureLoader loader = new TextureLoader("C:\\Users\\Public\\Pictures\\Sample Pictures\\metal.jpg", "LUMINANCE", new
                Container());
    ...
    private static Appearance getCylTowersAppearence() {
        // завантажуємо текстуру
        TextureLoader loader = new TextureLoader("C:\\Users\\Public\\Pictures\\Sample Pictures\\lines.png", "LUMINANCE", new
                Container());
