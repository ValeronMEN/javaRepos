...
public class NewClass extends JFrame{
    ...
    public NewClass(){
        //РјРµС…Р°РЅС–Р·Рј РґР»СЏ Р·Р°РєСЂРёС‚С‚СЏ РІС–РєРЅР° С‚Р° РІРёС…РѕРґСѓ Р· РїСЂРѕРіСЂР°РјРё
        this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

        //РїР°СЂР°РјРµС‚СЂРё РїРµСЂРµРіР»СЏРґСѓ СЃС†РµРЅРё Р·Р° Р·Р°РјРѕРІС‡Р°РЅРЅСЏРј
        myCanvas3D = new Canvas3D(SimpleUniverse.getPreferredConfiguration());

        //СЃС‚РІРѕСЂРµРЅРЅСЏ SimpleUniverse (РІС–СЂС‚СѓР°Р»СЊРЅРѕРіРѕ РІСЃРµСЃРІС–С‚Сѓ)
        SimpleUniverse simpUniv = new SimpleUniverse(myCanvas3D);

        //РїРѕР»РѕР¶РµРЅРЅСЏ РіР»СЏРґР°С‡Р° Р·Р° Р·Р°РјРѕРІС‡Р°РЅРЅСЏРј
        simpUniv.getViewingPlatform().setNominalViewingTransform();

        //СЃС‚РІРѕСЂРµРЅРЅСЏ СЃС†РµРЅРё
        createSceneGraph(simpUniv);

        //РґРѕРґР°РЅРЅСЏ СЃРІС–С‚Р»Р° Сѓ СЃС†РµРЅСѓ
        addLight(simpUniv);

        //РЅР°СЃС‚СѓРїРЅС– СЂСЏРґРєРё РґРѕР·РІРѕР»СЏСЋС‚СЊ РЅР°РІС–РіР°С†С–СЋ РїРѕ СЃС†РµРЅС– Р·Р° РґРѕРїРѕРјРѕРіРѕСЋ РјРёС€С–
        OrbitBehavior ob = new OrbitBehavior(myCanvas3D);
        ob.setSchedulingBounds(new BoundingSphere(new Point3d(0.0,0.0,0.0),Double.MAX_VALUE));
        simpUniv.getViewingPlatform().setViewPlatformBehavior(ob);

        //РїР°СЂР°РјРµС‚СЂРё РІС–РєРЅР° РїСЂРѕРіСЂР°РјРё
    ...
    public void createSceneGraph(SimpleUniverse su){
        ...
        //С‚Р° РІРёРІС–Рґ РІ РєРѕРЅСЃРѕР»СЊ РЅР°Р·РІ РѕР±'С”РєС‚С–РІ
    ...
    // ANIMATION -------------------------------------------------------------------------
        int noRotHour = 100; //РєС–Р»СЊРєС–СЃС‚СЊ РѕР±РµСЂС‚С–РІ
        int timeRotationHour = 300;//С‡Р°СЃ РѕРґРЅРѕРіРѕ РѕР±РµСЂС‚Сѓ
        ...
        float crawlDistance = 9.0f; //РІС–РґСЃС‚Р°РЅСЊ, РЅР° СЏРєСѓ РїСЂРѕСЃСѓРЅРµС‚СЊСЃСЏ РѕР±вЂ™С”РєС‚
...
//        sceneGroup.addChild(testRot);
    ...
    //------------------------------------------------------------------------------------------------------
        ...
        //СЃС‚РІРѕСЂСЋС”РјРѕ Р±С–Р»РёР№ С„РѕРЅ
        Background bg = new Background(new Color3f(1.0f,1.0f,1.0f));
        bg.setApplicationBounds(bounds);
        theScene.addChild(bg);
        theScene.compile();

        //РґРѕРґР°С”РјРѕ СЃС†РµРЅСѓ РґРѕ РІС–СЂС‚СѓР°Р»СЊРЅРѕРіРѕ РІСЃРµСЃРІС–С‚Сѓ
        su.addBranchGraph(theScene);
    }

    //РјРµС‚РѕРґ РґР»СЏ РіРµРЅРµСЂР°С†С–С— Р·РѕРІРЅС–С€РЅСЊРѕС— РїРѕРІРµСЂС…РЅС–
    public static void setToMyDefaultAppearance(Appearance app, Color3f col){
        app.setMaterial(new Material(col,col,col,col,150.0f));
    }

    //РјРµС‚РѕРґ РґР»СЏ РґРѕРґР°РІР°РЅРЅСЏ РѕСЃРІС–С‚Р»РµРЅРЅСЏ
